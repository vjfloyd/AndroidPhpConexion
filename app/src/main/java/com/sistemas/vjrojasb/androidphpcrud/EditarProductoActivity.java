...
public class EditarProductoActivity extends Activity {
    ...
    // single product url
    private static final String url_product_detials = "http://192.168.1.14:8888/android_connect/get_product_details.php";

    // url to update product
    private static final String url_update_product = "http://192.168.1.14:8888/android_connect/update_product.php";

    // url to delete product
    private static final String url_delete_product = "http://192.168.1.14:8888/android_connect/delete_product.php";
