 ...
 */
public class ListarProductosActivity extends ListActivity {
    ...
    private static String url_listar_productos = "url";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ListarProductosActivity.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_listar_productos, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ListarProductosActivity.this, productosList,
                            R.layout.listar_item, new String[] { TAG_PID,
                            TAG_NAME},
                            new int[] { R.id.pid, R.id.nombre });
                    // updating listview
